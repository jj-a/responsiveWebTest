...
<form name="modForm" method="post" action="memberModifyProc.jsp" onsubmit="return memberUdtCheck(this)">
	...
	<table border="1" class="writefrm">
		...
		<tr>
			<th>*이메일</th>
			<td colspan="2">
			<input type="text" name="email" id="email" value="<%=dto.getEmail()%>" size="30" readonly> 
		...
		<tr>
			<th>우편번호</th>
			<td>
			<input type="text" name="zipcode" id="zipcode" value="<%=Utility.checkNull(dto.getZipcode())%>" size="7" readonly> 
